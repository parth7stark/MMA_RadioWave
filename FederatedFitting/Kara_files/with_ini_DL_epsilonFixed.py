...
def log_likelihood(theta, nu, x, y, yerr):
    ...
    if z_known == True and dl_known == True:
        logE0, thetaObs, thetaCore, logn0, p, thetaWing = theta  # REMOVED logepsilon_e, logepsilon_B
        z = z_fixed
        DL = dl_fixed 

    elif z_known == True and dl_known == False:
        logE0, thetaObs, thetaCore, logn0, p, thetaWing, DL = theta  # REMOVED logepsilon_e, logepsilon_B
        z = z_fixed

    elif z_known == False and dl_known == True:
        logE0, thetaObs, thetaCore, logn0, p, thetaWing, z = theta  # REMOVED logepsilon_e, logepsilon_B
        DL = dl_fixed
        
    else:
        logE0, thetaObs, thetaCore, logn0, p, thetaWing, z, DL = theta  # REMOVED logepsilon_e, logepsilon_B
    ...
    "n0": n0,
    "p": p,
    "epsilon_e": epsilon_e,  # FIXED VALUE 0.1
    "epsilon_B": epsilon_B,  # FIXED VALUE 0.01
    "xi_N": 1.0,
    "d_L": DL,
    "z": z,
    }
...
if __name__ == "__main__":
    ...
    # np.random.seed(42)
    np.random.seed(777111)


    nwalkers = 32
    if z_known == True and dl_known == True:
        ndim = 6  # REDUCED FROM 8 (removed 2 epsilon parameters)
    ...
    # 7. UPDATE PARAMETER NAMES FOR RESULTS
    if z_known == True and dl_known == True:
        params = ['log(E0)','thetaObs','thetaCore','log(n0)','p', 'thetaWing']  # REMOVED epsilon params

    elif z_known == False and dl_known == True:
        params = ['log(E0)','thetaObs','thetaCore','log(n0)','p', 'thetaWing', 'z']  # REMOVED epsilon params

    elif z_known == True and dl_known == False:
        params = ['log(E0)','thetaObs','thetaCore','log(n0)','p', 'thetaWing', 'DL']  # REMOVED epsilon params

    else:
        params = ['log(E0)','thetaObs','thetaCore','log(n0)','p', 'thetaWing', 'z', 'DL']  # REMOVED epsilon params
...
def make_posterior_hists(samples):
    ...
    if ndim == 6:
        ...
        fig, axes = plt.subplots(3, 3, figsize=(16, 10))  # 3 rows, 3 columns (one empty)
    elif ndim == 8:
