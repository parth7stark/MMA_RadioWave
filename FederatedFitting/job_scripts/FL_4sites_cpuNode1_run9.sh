...
#SBATCH --job-name=FedFit_Distributed_2sites_node1_dayAll_run9   # job name
#SBATCH --time=04:20:00                         # dd-hh:mm:ss for the job

#SBATCH -e FedFit_Distributed_2sites_node1_dayAll_run9-err-%j.log
#SBATCH -o FedFit_Distributed_2sites_node1_dayAll_run9-out-%j.log
...
python ./examples/octopus/run_site.py --config ./examples/configs/0_Alexander.yaml --day "all" > 0_Alexander_dayAll_run9.log 2>&1 &
# python ./examples/octopus/run_site.py --config ./examples/configs/1_Broderick.yaml --day "all" > 1_Broderick_dayAll_run9.log 2>&1 &
# python ./examples/octopus/run_site.py --config ./examples/configs/2_Ghirlanda.yaml --day "all" > 2_Ghirlanda_dayAll_run9.log 2>&1 &
python ./examples/octopus/run_site.py --config ./examples/configs/3_Hallinan.yaml --day "all" > 3_Hallinan_dayAll_run9.log 2>&1 &

# python ./examples/octopus/run_site.py --config ./examples/configs/4_Kim.yaml --day "all"> 4_Kim_dayAll_run9.log 2>&1 &
# python ./examples/octopus/run_site.py --config ./examples/configs/5_Remsi.yaml --day "all" > 5_Remsi_dayAll_run9.log 2>&1 &
# python ./examples/octopus/run_site.py --config ./examples/configs/6_Troja.yaml --day "all" > 6_Troja_dayAll_run9.log 2>&1 &
# python ./examples/octopus/run_site.py --config ./examples/configs/7_Makhatini.yaml --day "all" > 7_Makhatini_dayAll_run9.log 2>&1 &
