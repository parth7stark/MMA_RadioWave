...
#SBATCH --job-name=FedFit_Distributed_4sites_node1_day50   # job name
#SBATCH --time=03:15:00                         # dd-hh:mm:ss for the job

#SBATCH -e FedFit_Distributed_4sites_node1_day50-err-%j.log
#SBATCH -o FedFit_Distributed_4sites_node1_day50-out-%j.log
...
python ./examples/octopus/run_site.py --config ./examples/configs/0_Alexander.yaml --day "50" > 0_Alexander_day50.log 2>&1 &
python ./examples/octopus/run_site.py --config ./examples/configs/1_Broderick.yaml --day "50" > 1_Broderick_day50.log 2>&1 &
python ./examples/octopus/run_site.py --config ./examples/configs/2_Ghirlanda.yaml --day "50" > 2_Ghirlanda_day50.log 2>&1 &
python ./examples/octopus/run_site.py --config ./examples/configs/3_Hallinan.yaml --day "50" > 3_Hallinan_day50.log 2>&1 &
