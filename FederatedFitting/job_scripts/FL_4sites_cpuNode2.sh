...
#SBATCH --job-name=FedFit_Distributed_4sites_node2_dayAll_resilientrun4   # job name
#SBATCH --time=05:15:00                         # dd-hh:mm:ss for the job

#SBATCH -e FedFit_Distributed_4sites_node2_dayAll_resilientrun4-err-%j.log
#SBATCH -o FedFit_Distributed_4sites_node2_dayAll_resilientrun4-out-%j.log
...
python ./examples/octopus/run_site.py --config ./examples/configs/4_Kim.yaml --day "all"> 4_Kim_dayAll_resilientrun4.log 2>&1 &
python ./examples/octopus/run_site.py --config ./examples/configs/5_Remsi.yaml --day "all" > 5_Remsi_dayAll_resilientrun4.log 2>&1 &
python ./examples/octopus/run_site.py --config ./examples/configs/6_Troja.yaml --day "all" > 6_Troja_dayAll_resilientrun4.log 2>&1 &
python ./examples/octopus/run_site.py --config ./examples/configs/7_Makhatini.yaml --day "all" > 7_Makhatini_dayAll_resilientrun4.log 2>&1 &
